...
CREATE TABLE IF NOT EXISTS foods (
  ...
  source_detail TEXT DEFAULT 'seed',
...
INSERT OR IGNORE INTO foods (id, name, normalized_name, source, source_detail, is_estimated) VALUES
  ('food_egg', 'Egg, whole, raw', 'egg, whole, raw', 'seed', 'seed', 0),
  ('food_chicken', 'Chicken breast, cooked', 'chicken breast, cooked', 'seed', 'seed', 0),
  ('food_banana', 'Banana, raw', 'banana, raw', 'seed', 'seed', 0),
  ('food_oats', 'Oats, rolled, dry', 'oats, rolled, dry', 'seed', 'seed', 0),
  ('food_oliveoil', 'Olive oil', 'olive oil', 'seed', 'seed', 0),
  ('food_salmon', 'Salmon, cooked', 'salmon, cooked', 'seed', 'seed', 0),
  ('food_spinach', 'Spinach, raw', 'spinach, raw', 'seed', 'seed', 0),
  ('food_rice', 'Brown rice, cooked', 'brown rice, cooked', 'seed', 'seed', 0),
  ('food_milk', 'Milk, 2% fat', 'milk, 2% fat', 'seed', 'seed', 0),
  ('food_almonds', 'Almonds, raw', 'almonds, raw', 'seed', 'seed', 0),
  ('food_broccoli', 'Broccoli, raw', 'broccoli, raw', 'seed', 'seed', 0),
  ('food_apple', 'Apple, raw', 'apple, raw', 'seed', 'seed', 0),
  ('food_quinoa', 'Quinoa, cooked', 'quinoa, cooked', 'seed', 'seed', 0),
  ('food_yogurt', 'Greek yogurt, plain', 'greek yogurt, plain', 'seed', 'seed', 0),
  ('food_tofu', 'Tofu, firm', 'tofu, firm', 'seed', 'seed', 0);
